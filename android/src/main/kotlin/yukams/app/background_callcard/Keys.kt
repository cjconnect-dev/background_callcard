...
class Keys {
    companion object {
        ...
        @JvmStatic
        val METHOD_PLUGIN_SHOW_OVERLAY_VIEW = "LocatorPlugin.showOverlayView"

        @JvmStatic
        val METHOD_PLUGIN_CLOSE_OVERLAY_VIEW = "LocatorPlugin.closeOverlayView"
        ...
        @JvmStatic
        val NOTIFICATION_ACTION = "com.yukams.callcard.notification"
    }
}